...
class DrumResNet(nn.Module):
    def __init__(self, num_classes=15, n_mels=128):
        ...
        self.time_norm_branch = nn.Sequential(
            ...
            ResidualBlock2d(64, 64, stride=2)
        )
        ...
        # Classifier (特徴量の統合)
        # ---------------------------------------------------------
        # 各ブランチの出力: 128チャネル × 4(周波数帯域) × 1(時間) = 512次元
        # 2つのブランチを結合: 512 + 512 = 1024次元
        #self.fc1 = nn.Linear(1024, 128)
        self.fc1 = nn.Linear(64*4+32*4, 128)
